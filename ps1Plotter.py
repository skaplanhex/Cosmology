...
leg.AddEntry(a4plot,"#Lambda #neq0, w=-1","L")
leg.AddEntry(a5plot,"Quintessence","L")
leg.Draw()

c.SaveAs("ps1_plots/a1-5.pdf")
...
h1plot.GetYaxis().SetTitle("H(t)")
h1plot.GetYaxis().SetTitleOffset(1.2)
h1plot.SetTitle("")
h1plot.Draw("AL")
h2plot.Draw("L")
h3plot.Draw("L")
...
leg.AddEntry(h4plot,"#Lambda #neq0, w=-1","L")
